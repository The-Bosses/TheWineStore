...
const seed = async()=> {
  ...
  const [plonk_white, plone_rose, plonk_red, plonk_sparkling, oh_schist, enchanted_garden, anthony_road, santa, voga, ecco, hayes, fog_bank, kim_craw, oyster, invivo, unshackled_by, sun_goddess, river_road, oak_grove, la_crema, j_lohr, ferrari, decoy_cali, tuli, caliveda, le_colline, la_belle, prototype, double_black, gnarled, oak_ridge, sobon, bread_butter, nineteen_crimes, chateau, eccentric, unshackled, la_vostra, la_marca, cupcake, naveran, rondel, lini, le_grand, le_marca_rose ] = await Promise.all([
    createProduct({ name: 'Blanc Thoughts', type: 'Sauvignon Blanc', location: 'United States', alcohol_percent: 10.5, description: ' Our house special, "Blanc Thoughts" Sauvignon Blanc, is a pale straw wine delighted with fragrant notes of citrus blossom, tropical fruits, and subtle herbs.  Enjoy this Sauvignon Blanc as a delightful aperitif or paired with light, fresh fare, letting its bright and uplifting character elevate any moment.', price: 4.99, reviews: 'The palate is a refreshing dance of zesty grapefruit, lively lemon, and juicy passion fruit, culminating in a crisp, balanced finish', is_vip: false, image:'../../public/winePics/Plonk-White.png' }),
    createProduct({ name: 'Rosy Cheeks', type: 'Rosé', location: 'United States', alcohol_percent: 12.5, description: '"Rosy Cheeks" is a charming and blush-hued rosé wine that beckons with a playful and lively spirit. It has a delicate pink color that sets the stage for a sensory journey, revealing a bouquet of fresh strawberries, watermelon, and hints of floral notes. ', price: 5.99, reviews: '"Rosy Cheeks" is an invitation to savor the moment and celebrate with a glass of pure delight.', is_vip: false, image:'../../public/winePics/Plonk-Rose.png' }),
    createProduct({ name: 'Deadly Zins', type: 'Zinfandel', location: 'United States', alcohol_percent: 17, description: '"Deadly Zins" is a robust Zinfandel that commands attention. With its deep, inky color, this wine offers a complex blend of dark berries, black cherries, and a hint of spicy black pepper. The full-bodied palate showcases ripe blackberries and plums with a touch of cocoa. ', price: 4.99, reviews: 'Well-integrated tannins and a lingering finish make "Deadly Zins" a powerful and memorable choice for those who appreciate bold red wines.', is_vip: false, image:'../../public/winePics/Plonk-Red.png' }),
    createProduct({ name: 'Get Plonked', type: 'Prosecco', location: 'United States', alcohol_percent: 11, description: '"Get Plonked" Prosecco is a lively and effervescent delight that invites you to celebrate with every sip. With its bright, bubbly character, this Prosecco offers crisp notes of green apple, citrus, and a touch of floral elegance.', price: 6.99, reviews: 'Perfect for toasting, "Get Plonked" adds a refreshing sparkle to any occasion, making it the go-to choice for those who appreciate a light-hearted and effervescent Prosecco experience.', is_vip: false, image:'../../public/winePics/Plonk-Sparkling.png' }),
