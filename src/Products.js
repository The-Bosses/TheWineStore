  ...
  useEffect(() => {
    const filterAndSort = () => {
      ...
      if (filter === "vip") {
        ...
        filteredandSorted = filteredandSorted.filter(
          (product) => product.type === "Cabernet Sauvignon" || product.type === "Pinot Noir" || product.type === "Zinfandel"
        )
        ...
        filteredandSorted = filteredandSorted.filter(
          (product) => product.location === "Australia" || product.location === "New Zealand" 
        )
      } else if (filter === "europe") {
        filteredandSorted = filteredandSorted.filter(
          (product) => product.location === "Germany" || product.location === "Italy" || product.location === "France" || product.location === "Spain"
        )
    ...
    <div className="bg-red-950">
      ...
      <div className="mb-4">
        ...
        >
          ...
          <option value="weakToStrong">Alcohol Percentage: Low to High</option>
          <option value="strongToWeak">Alcohol Percentage: High to Low</option>
        </select>
      </div>
      <div>
        {filter === "none" && sortBy === "none" ? null : (
          <button className=" ml-2 w-32 px-3 py-2 rounded-lg mb-2 focus:outline-none focus:ring focus:ring-offset-2 uppercase tracking-wider font-semibold text-sm sm:text-base bg-red-800 text-red-50 hover:bg-red-900 focus:ring-red-800 focus:ring-opacity-50 active:bg-red-800"
            ...
            return (
              ...
              >
                <div className="flex-grow text-center">
                  ...
                  <div className="text-red-900 text-base">
                    {product.type}
                  </div>
